...
- Selective curriculum variant of NPO on TOFU.
...
Selective-NPO is a TOFU variant of the selective curriculum idea. If you use it, cite the OpenUnlearning technical report and the Selective DPO paper that motivates the curriculum idea.
